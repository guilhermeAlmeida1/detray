...
GTEST_TEST(detray_core, detector) {
    ...
    using detector_t =
        detector<detector_registry::default_detector::bfield_backend_t, detector_registry::default_detector, covfie::field>;
    using mask_id = typename detector_t::masks::id;
    using material_id = typename detector_t::materials::id;
...
GTEST_TEST(detray_tools, detector_volume_construction) {
    ...
    using detector_t =
        detray::detector<detector_registry::default_detector::bfield_backend_t, detector_registry::default_detector, covfie::field>;
    using transform3 = typename detector_t::transform3;
